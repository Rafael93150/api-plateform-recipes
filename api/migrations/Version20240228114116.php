 ...
 */
final class Version20240228114116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quantity (id INT NOT NULL, ingredient_id INT NOT NULL, recipe_id INT NOT NULL, amount INT NOT NULL, unit VARCHAR(63) DEFAULT NULL, PRIMARY KEY(id))');
